 ...
 */
public class CustomDateTimeWheelDialog extends Dialog {

    private final String TAG = "CustomDateTimeWheelDialog";
    ...
    private int showConfig = DateTimeWheelDialog.SHOW_YEAR_MONTH_DAY_HOUR_MINUTE;
    private float textSize = 24f;
    private int markLineColor = R.color.wheel_title_bar_ok_color;

    public CustomDateTimeWheelDialog(@NonNull Context context) {
        this(context, R.style.WheelDialog);
    }

    public CustomDateTimeWheelDialog(@NonNull Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frame_wheel_dialog_base);
        initView();
    }
    ...
    private void initView() {
        ...
        yearWheelItemView.setTextSize(textSize);
        yearWheelItemView.setMaskLineColor(ContextCompat.getColor(getContext(),markLineColor));
        ...
        monthWheelItemView.setTextSize(textSize);
        monthWheelItemView.setShowCount(showCount);
        monthWheelItemView.setMaskLineColor(ContextCompat.getColor(getContext(),markLineColor));
        ...
        dayWheelItemView.setTextSize(textSize);
        dayWheelItemView.setMaskLineColor(ContextCompat.getColor(getContext(),markLineColor));
        ...
        hourWheelItemView.setTextSize(textSize);
        hourWheelItemView.setMaskLineColor(ContextCompat.getColor(getContext(),markLineColor));
        ...
        minuteWheelItemView.setTextSize(textSize);
        minuteWheelItemView.setMaskLineColor(ContextCompat.getColor(getContext(),markLineColor));
        ...
        tvCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!cancelCallBack.callBack(v, selectedCalendar)) dismiss();
            }
        });
        tvOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!okCallBack.callBack(v, selectedCalendar)) dismiss();
            }
        });
    }
    ...
    public void configShowUI(@DateTimeWheelDialog.ShowConfig int config) {
        configShowUI(config, -1);
    }

    public void configShowUI(@DateTimeWheelDialog.ShowConfig int showConfig, int totalOffsetX) {
        ensureIsViewInitialized();
        if (totalOffsetX == -1) {
        ...
        switch (showConfig) {
            case DateTimeWheelDialog.SHOW_YEAR:
                ...
                break;
            case DateTimeWheelDialog.SHOW_YEAR_MONTH:
                yearWheelItemView.setVisibility(View.VISIBLE);
                ...
                minuteWheelItemView.setVisibility(View.GONE);
                break;
            case DateTimeWheelDialog.SHOW_YEAR_MONTH_DAY:
                yearWheelItemView.setVisibility(View.VISIBLE);
                monthWheelItemView.setVisibility(View.VISIBLE);
                ...
                break;
            case DateTimeWheelDialog.SHOW_YEAR_MONTH_DAY_HOUR:
                yearWheelItemView.setVisibility(View.VISIBLE);
                monthWheelItemView.setVisibility(View.VISIBLE);
                dayWheelItemView.setVisibility(View.VISIBLE);
                ...
                break;
            case DateTimeWheelDialog.SHOW_YEAR_MONTH_DAY_HOUR_MINUTE:
                yearWheelItemView.setVisibility(View.VISIBLE);
                monthWheelItemView.setVisibility(View.VISIBLE);
                dayWheelItemView.setVisibility(View.VISIBLE);
                hourWheelItemView.setVisibility(View.VISIBLE);
    ...
    public void setMarkLineColor(int colorRes)
    {
        this.markLineColor = colorRes;
    }
    ...
    private void initOnScrollListener() {
        yearWheelItemView.setOnSelectedListener(new WheelView.OnSelectedListener() {
            ...
            public void onSelected(Context context, int selectedIndex) {
                ...
                if (showConfig > DateTimeWheelDialog.SHOW_YEAR)
                    onYearChanged();
            }
        });
        monthWheelItemView.setOnSelectedListener(new WheelView.OnSelectedListener() {
            ...
            public void onSelected(Context context, int selectedIndex) {
                ...
                if (showConfig > DateTimeWheelDialog.SHOW_YEAR_MONTH)
                    onMonthChanged();
            }
        });
        dayWheelItemView.setOnSelectedListener(new WheelView.OnSelectedListener() {
            ...
            public void onSelected(Context context, int selectedIndex) {
                ...
                if (showConfig > DateTimeWheelDialog.SHOW_YEAR_MONTH_DAY)
                    onDayChanged();
            }
        });
        hourWheelItemView.setOnSelectedListener(new WheelView.OnSelectedListener() {
            ...
            public void onSelected(Context context, int selectedIndex) {
                ...
                if (showConfig > DateTimeWheelDialog.SHOW_YEAR_MONTH_DAY_HOUR)
                    onHourChanged();
            }
        });
    ...
    private boolean isScrolling() {
        ...
        } else if (showConfig == DateTimeWheelDialog.SHOW_YEAR_MONTH) {
            return yearWheelItemView.isScrolling()
                    || monthWheelItemView.isScrolling();
        } else if (showConfig == DateTimeWheelDialog.SHOW_YEAR_MONTH_DAY) {
            return yearWheelItemView.isScrolling()
                    || monthWheelItemView.isScrolling()
                    || dayWheelItemView.isScrolling();
        } else if (showConfig == DateTimeWheelDialog.SHOW_YEAR_MONTH_DAY_HOUR) {
            return yearWheelItemView.isScrolling()
                    || monthWheelItemView.isScrolling()
                    || dayWheelItemView.isScrolling()
    ...
    public interface OnClickCallBack {
        boolean callBack(View v, Calendar selectedDate);
    }
}