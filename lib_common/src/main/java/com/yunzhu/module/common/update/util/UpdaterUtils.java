package com.yunzhu.module.common.update.util;
...
public class UpdaterUtils {
    ...
    private static final String SP_FILE_NAME = "download_sp";
    ...
    public static boolean compare(Context context, Uri uri) {
        ...
        try {
            ...
            if (BuildConfig.DEBUG) {
                ...
                Logger.e("current app packageName=" + currentPackageInfo.packageName +
    ...
    public static long getLocalDownloadId(Context context) {
        return PreferencesUtils.getLong(context, SP_FILE_NAME, KEY_DOWNLOAD_ID, -1L);
    }

    public static void saveDownloadId(Context context, long id) {
        PreferencesUtils.putLong(context, SP_FILE_NAME, KEY_DOWNLOAD_ID, id);
    }
