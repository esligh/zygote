/*****************************************************************************************
 * Project Key : sdk-server
 * Create on 2019年5月16日 下午3:38:06
 * Copyright (c) 2008 - 2019.深圳市快付通金融网络科技服务有限公司版权所有. 粤ICP备10228891号
 * 注意：本内容仅限于深圳市快付通金融网络科技服务有限公司内部传阅，禁止外泄以及用于其他的商业目的
 ****************************************************************************************/
package com.yunzhu.module.common.crypto.sm4;
...
public class SM4Util {
    ...
    public static SM4Util newInstance()
    {
        return new SM4Util();
    }
    ...
    public static byte[] getByteKey(String key) throws NoSuchProviderException, NoSuchAlgorithmException {

        KeyGenerator kg = KeyGenerator.getInstance(ALGORITHM_NAME, BouncyCastleProvider.PROVIDER_NAME);
        kg.init(DEFAULT_KEY_SIZE, new SecureRandom(key.getBytes()));
        return kg.generateKey().getEncoded();
    }
