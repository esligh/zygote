...
//      String c11 = Util.byteToHex(c1.getEncoded());
        //L.d("C1: " + c11+",len="+c11.length());
//      String s = Util.byteToHex(source);
        //L.d("C2: " + s+",len="+s.length());
//      String c33 = Util.byteToHex(c3);
        //L.d("C3: " + s+",len="+c33.length());
        //C1 C2 C3拼装成加密字串
        // C1 | C2 | C3
...
//        prik=privatekey;
//        pubk=publicKey;
//        SM2KeyVO keyPair = generateKeyPair();
//        String pubk = keyPair.getPriHexInSoft();
//        String prik = keyPair.getPubHexInHard();
...
//        SM2KeyVO sm2KeyVO = generateKeyPair();
        String pubKey = "3059301306072A8648CE3D020106082A811CCF5501822D03420004d4f8a6914a2bae0875d869c08c46fc45aeb6e77542c1bdf49e6be1f2e6faf7418cd129b6b7452b5a1a7fd79371e1911a5f78a35da5bce5794357399a8f0fce6a";
        String privKey = "7f5970fa214a338278ae7347309cbfb20e8e5126a1e7899268821aa854506d29";
        System.out.println("公钥:" + pubKey+",len="+pubKey.length());
        System.out.println("私钥:" + privKey+",len="+privKey.length());
        //数据加密
        System.out.println("--测试加密开始--");
        String src = "34dc61ba89bd9dc31135246db0972380791461ac45b0935f6d7cc622d76f7debb5264f3b232a29df0f584ae5a4a8fce14963e5d52044763f27125d64cd5af3ae4f5f74650c13d90c74460b4d13a7fb53a1653bef062a577be0d3a4b546507ece";
        System.out.println("src:"+src);
        System.out.println("原文UTF-8转hex:" + Util.byteToHex(src.getBytes()));
        String SM2Enc = SM2Enc(pubKey, src);
        System.out.println("加密:");
        System.out.println("密文:" + SM2Enc+",len="+SM2Enc.length());
        String SM2Dec = SM2Dec(privKey, SM2Enc);
...
//        String encrypt = SM2Utils.encrypt(ByteUtils.fromHexString(pubKey),src.getBytes());
        //删除04
